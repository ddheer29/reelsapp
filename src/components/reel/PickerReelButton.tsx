...
const PickerReelButton: FC = () => {
  ...
  const handleCamera = async () => {
    await launchCamera({
      ...
      .catch((err) => {
        console.log("🚀 ~ .Error while video recording ~ err:", err)
      })
  }
    ...
    <View style={styles.flexRowBetween}>
      <TouchableOpacity style={styles.btn} onPress={() => handleCamera()}>
        <Icon
          ...
          size={RFValue(20)}
        />
        <CustomText variant='h8' style={styles.btnText}>Camera</CustomText>
      </TouchableOpacity>
      <TouchableOpacity style={styles.btn}>
        <Icon2
          ...
          size={RFValue(20)}
        />
        <CustomText variant='h8' style={styles.btnText}>Drafts</CustomText>
      </TouchableOpacity>
      <TouchableOpacity style={styles.btn}>
        <Icon2
          name='auto-fix-high'
          ...
          size={RFValue(20)}
        />
        <CustomText variant='h8' style={styles.btnText}>Templates</CustomText>
      </TouchableOpacity>
    </View>
  )
}
